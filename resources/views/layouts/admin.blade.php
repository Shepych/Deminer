...
<head>
    ...
    {{--  Стили пакета загрузчика файлов  --}}
...
<div class="wrapper">
    ...
    <!-- Preloader -->
    <div style="background-color: #212b3d" class="preloader flex-column justify-content-center align-items-center">
...
{{--    </nav>--}}
    ...
    <aside  style="background-color: #212b3d" class="main-sidebar sidebar-dark-primary elevation-4">
        <!-- Sidebar -->
        <div class="sidebar">
...
{{--            </div>--}}
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" style="margin-bottom: 8px">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item" style="margin-bottom: 8px">
                                <a href="{{ route('articlesList') }}" class="nav-link">
                                    <p>Все статьи</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('articlesAdd') }}" class="nav-link">
                                    <p>Добавить статью</p>
                                </a>
                            </li>
                        </ul>
...
{{--                    </li>--}}
    ...
    <div class="content-wrapper" style="background-color: #151c29">
        @yield('content')
    </div>
