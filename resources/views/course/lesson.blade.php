...
@section('content')
    <main>
        <div class="article__main">
            <h1 class="article__main__title" style="text-align: center;">{{$lesson->title}}</h1>
            <div class="article__info">
                ...
                <span>
                    <svg style="margin-right: 4px" xmlns="http://www.w3.org/2000/svg" width="20" fill="currentColor" class="bi bi-clock" viewBox="0 0 16 16">
        ...
        <div class="pagination" style="margin-top: 20px">
            <a @if($previousPost) href="/lesson/{{ $previousPost->id }}"  @endif class="pagination__item">
                @if($previousPost)
            ...
            <a @if($nextPost) href="/lesson/{{ $nextPost->id }}  " @endif class="pagination__item">
                @if($nextPost)
